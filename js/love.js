...
// Danh sách 2 ảnh xen kẽ
const imageList = [
    "images/img6.jpg"
];

// Gán ảnh cho từng div theo thứ tự 1, 2, 1, 2,...
document.querySelectorAll('.love .block div').forEach((div, i) => {
    div.style.backgroundImage = `url('${imageList[i % imageList.length]}')`;
});
